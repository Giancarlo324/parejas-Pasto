        ...
        <div class="row">
            <div class="card-body">
                ...
                if ($conexion) {
                    ...
                    $misGutos2 = "SELECT Nombre, Apellido, foto1, quien_gusta FROM usuario INNER JOIN megusta ON usuario.id = megusta.quien_gusta WHERE id_usuario = ? and quien_gusta is not NULL";
                    // Consulta en donde podré saber el total de personas a mostrar por pagina y son las que indicaré.
                    $misGutos = "SELECT Nombre, Apellido, foto1, quien_gusta FROM usuario INNER JOIN megusta ON usuario.id = megusta.quien_gusta WHERE id_usuario = ? and quien_gusta is not NULL LIMIT ?, ?";
